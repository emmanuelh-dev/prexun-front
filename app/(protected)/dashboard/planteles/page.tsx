...
export default function Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: `Plantel ${selectedCampus ? 'actualizado' : 'creado'} correctamente`,
      });
                ...
                {isLoading ? (
                  ...
                  campuses.map((campus) => (
                    <TableRow key={campus.id}>
                      ...
                      <TableCell>
                        {campus.address || 'No especificada'}
                      </TableCell>
                      <TableCell>
                        <span
                          className={
            ...
            >
              <DialogContent>
                ...
                <form
                  ...
                  className="grid grid-cols-2 w-full gap-2 max-h-[80vh] overflow-y-auto"
                >
                  <div>
