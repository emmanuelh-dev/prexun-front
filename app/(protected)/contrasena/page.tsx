...
export default function ChangePasswordPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setStatusMessage({ type: 'error', text: 'Error al guardar la contraseña. Intenta de nuevo.' });
    } finally {
      setIsLoading(false);
    }
  }
    ...
    <div className="container mx-auto py-10 px-4">
      <Card className="max-w-md mx-auto shadow-md">
        <CardHeader className="bg-sky-50 dark:bg-slate-900 border-b">
          <CardTitle className="text-xl text-sky-700 dark:text-sky-400">Cambiar Contraseña</CardTitle>
        </CardHeader>
